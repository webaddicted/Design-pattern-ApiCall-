...
public abstract class NetworkBoundResource<ResultType, RequestType> {
    ...
    protected NetworkBoundResource(AppExecutors appExecutors) {
        ...
        result.setValue(Resource.loading(null, AppConstants.ZERO_STATUS_CODE));
        ...
        result.addSource(dbSource, data -> {
            ...
            if (shouldFetch(data)) {
                ...
                result.addSource(dbSource, newData -> result.setValue(Resource.success(newData, AppConstants.ZERO_STATUS_CODE)));
            }
        });
    }
    ...
    private void fetchFromNetwork(final LiveData<ResultType> dbSource) {
        ...
        result.addSource(dbSource, newData -> result.setValue(Resource.loading(newData, AppConstants.ZERO_STATUS_CODE)));
